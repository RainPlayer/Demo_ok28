...
public final class RegexUtils {
    ...
    /**
     * 验证密码  8-16的 字母+数字  不能全是字母或数字
     *
     * @param input 待验证文本
     * @return {@code true}: 匹配<br>{@code false}: 不匹配
     */
    public static boolean isPasswordSimple(final CharSequence input) {
     ...
     * @return {@code true}: 匹配<br>{@code false}: 不匹配
     */
    public static boolean isYouBianSimple(final CharSequence input) {
        return isMatch(RegexConstants.REGEX_YOUBI, input);
    }
}
