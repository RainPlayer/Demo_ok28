...
import static com.zqf.base.util.utils_blankj.ActivityUtils.getActivityList;
import static com.zqf.base.util.utils_blankj.ApplicationUtils.getApp;
...
public final class AppUtils {
    ...
    public static void registerAppStatusChangedListener(@NonNull final Object obj,
                                                        @NonNull final ApplicationUtils.OnAppStatusChangedListener listener) {
        ApplicationUtils.getActivityLifecycle().addListener(obj, listener);
    }
    ...
    public static void unregisterAppStatusChangedListener(@NonNull final Object obj) {
        ApplicationUtils.getActivityLifecycle().removeListener(obj);
    }
